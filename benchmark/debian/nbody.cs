...
Time elapsed 00:00:01.5921756
 

2.43s to complete and log all make actions

COMMAND LINE:
/usr/bin/dotnet ./bin/Release/netcoreapp1.0/tmp.dll 50000000
...
public class NBody : Bench.BenchTest
{
  ...
  public int n = 50000000;

  // public static void Run(String[] args)
  // {
  //     var nbody = new NBody { InputArgs = args };
  //     nbody.RunTest();
  // }
